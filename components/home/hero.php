                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="img/bg1.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                    <a href="shop.php" class="btn px-4 py-2 text-white rounded">Vegetables</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="img/bg2.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                                    <a href="shop.php" class="btn px-4 py-2 text-white rounded">Fruit</a>
                                </div>
                            </div>
